...
class PR_Api_Core_ClientClass
{
    ...
    private $avaiUpdateFields1 = array('Companyname','Industry','Address','Address2','Description','images','PhoneNumber','faxnumber','country','emailinfo','Zipcode','city','state');
